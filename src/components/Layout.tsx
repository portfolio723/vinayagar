          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg sm:text-2xl font-bold text-black">Vinayaka Chavithi 2025</h1>
      ...
      <footer className="border-t border-gray-100 bg-gray-50/50 mt-16">
        <div className="max-w-7xl mx-auto mobile-padding">
          <div className="text-center">
            ...
            <h3 className="mobile-subheading font-semibold text-black mb-2">Vinayaka Chavithi Festival</h3>
            <p className="mobile-text text-gray-600 max-w-2xl mx-auto mb-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-8 text-xs sm:text-sm text-gray-500">
